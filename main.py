...
def create_layer(layer_style):
    ...
    if layer_style == 'b':
        ...
        min_rad = height
        max_rad = width
        line_width = random.randrange(15, 29)
        color_style = random.choice(['c', 'c', 'a', 'm', 'm'])
        blur_rad = random.randrange(11, 23)
        ...
        blur_rad = random.randrange(9, 15)
        ...
        min_rad = height * 0.4
        max_rad = width * 0.6
        line_width = random.randrange(5, 8)
        color_style = random.choice(['c', 'c', 'm'])
        blur_rad = random.randrange(1, 3)
